...
public class MK_1SaveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mk_1_save);
    ...
    private void takeScreenshot() {
        ...
        File mPath = new File (Environment.getExternalStorageDirectory() + "/Дети мира/Мульт-контак/");
        mPath.mkdirs();
