...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentTransaction.replace(R.id.inc_main,new Main());
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.nav_about:
                /*findViewById(R.id.inc_main).setVisibility(View.GONE);
                findViewById(R.id.inc_about).setVisibility(View.INVISIBLE);*/

                Intent intent = new Intent(MainActivity.this, AboutActivity.class);
                startActivity(intent);

                /*android.support.v4.app.FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
                fragmentTransaction.replace(R.id.inc_main,new About());
                fragmentTransaction.commit();*/
