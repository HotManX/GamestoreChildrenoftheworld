...
public class Pikt_1SaveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pikt_1_save);
    ...
    private void takeScreenshot() {
        ...
        File mPath = new File (Environment.getExternalStorageDirectory() + "/Дети мира/Пиктограф/");
        mPath.mkdirs();
